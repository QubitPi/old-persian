...
\begin{enumerate}
    \item {\oldpersian ;}\stackunder{{\oldpersian adm}}{(Pronoun) I\cite{adm}} {\oldpersian ;} \stackunder{{\oldpersian daryvuS}}{Darius\textsuperscript{\cite[p185]{rawlinson1849memoir}}\cite{darius}}{\oldpersian ;} \stackunder{\oldpersian xsayoiy}{Alternative form of {\oldpersian Q}\cite{alternativeKing}} {\oldpersian ;} \stackunder{{\oldpersian vzrk}}{great\cite{great}} {\oldpersian ;}
\end{enumerate}
